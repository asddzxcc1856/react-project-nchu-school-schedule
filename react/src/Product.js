            ...
            <>
                <table id="sel">
                    <tbody><tr>
                        ...
                        <td>
                            <span >課程分類：</span><select name="v_subject" id="sel-subject">
                                <option value="1">體育</option>
                                <option value="7">國防(106學年前)</option>
                                <option value="B">服務學習</option>
                                <option value="4">教育學程</option>
                                <option value="5">暑修</option>
                                <option value="0">全校可選修</option>
                                <option value="H">全校英外語</option>
                            </select>
                        </td>
                ...
                <table id="sel">
                    <tbody>
                        <tr>
                            ...
                            <td><span className="word_13">選課號碼：<input name="v_crseno" type="text" id="sel-crseno" size="8" />
                            </span></td>
                        </tr>
                    </tbody></table>
                <Progress2 />
