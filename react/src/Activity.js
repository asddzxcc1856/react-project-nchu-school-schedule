            ...
            <>
                <table id="sel">
                    <tbody><tr>
                        ...
                        <td>
                            <span >通識分類：</span><select name="p_subject" id="sel-subject">
                                <option value="E" defaultValue>人文領域</option>
                                <option value="F">社會領域</option>
                                <option value="G">自然領域</option>
                                <option value="K">統合領域</option>
                                <option value="M">核心素養</option>
                                <option value="L">通識資訊素養</option>
                                <option value="3">大學國文</option>
                                <option value="8">大一英文(109)學年前</option>
                                <option value="N">外國語文(110學年後)</option>
                            </select>
                        </td>
                        <td>
                            <span>通識學群：
                                <select name="p_group" id="sel-group">
                            ...
                            <td><span className="word_13">授課語言：
                                <select name="p_lang" id="sel-lang">
                                    <option value=""></option>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="word_13">科目：
                                <input name="p_crsName" type="text" id="sel-crsName" size="14" />
                            </td>
                            <td><span className="word_13">教師：
                                <input name="p_teacher" type="text" id="sel-teacher" size="7" maxLength="5" />
                            </span>
                            </td>
                            <td><span className="word_13">星期：
                                <select name="p_week" id="sel-week">
                                    <option value=""></option>
